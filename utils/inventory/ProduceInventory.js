...
const ProduceInventory = generateSalesData(produce, 11000, 75000, 289000);
...
const updatedProduce = generateSalesData(produce, 11000, 75000, 289000);
console.log(updatedProduce);

export default updatedProduce;
*/
}
