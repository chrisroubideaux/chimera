...
import LinensInventory from '@/data/inventory/LinensInventory';
...
const updatedLinensInventory = generateSalesData(
  LinensInventory,
  11000,
  75000,
  289000
);
console.log(updatedLinensInventory);

export default updatedLinensInventory;
