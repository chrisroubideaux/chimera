  ...
  const entrees: Entrees[] = [
    {
      ...
      description: '12oz ribeye served with broccolini and choice of baked or loaded mashed potato.',
      price: '38',
      count: '5',
      par: '',
      options: [
    ...
    },
    {
      ...
      description: 'Rack of lamb served with mashed potato and choice of broccolini, brussels sprouts, or green beans served with demi-glaze.',
      price: '45',
      count: '5',
      par: '',
      options: [
        {
          sides: ['Mashed Potato', 'Broccolini', 'Brussels Sprouts', 'Green Beans'],
        },
        {
          sauce: 'Demi-glaze',
        },
    ...
    },
    {
      ...
      description: 'House made double cheeseburger with house bacon and BBQ sauce served with fries.',
      price: '15',
      count: '5',
      par: '',
      options: [
