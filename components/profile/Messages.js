...
export default function Messages({ setActiveComponent }) {
  ...
  // Fetch messages and set sender/recipient IDs
  useEffect(() => {
    async function fetchMessages() {
      try {
        ...
        if (fetchedMessages.length > 0) {
          ...
          setSender(sampleMessage.sender._id); // Assume current user is the sender
  ...
  const handleSubmit = async (e) => {
    ...
    const messageData = {
      sender,
      recipient,
      senderModel: 'Employee', // Modify as necessary
      recipientModel: 'Admin', // Modify as necessary
        ...
        <div className="card-body h-100">
          <div className="tab-content py-0 mb-0 h-100" id="chatTabsContent">
            ...
            >
              ...
              <form className="chat-input-form mt-3" onSubmit={handleSubmit}>
