...
import BeveragesInventory from '@/utils/inventory/BeveragesInventory';
import beveragesData from '@/data/inventory/beverages';
...
export default function Beverages() {
  ...
  const beverages = BeveragesInventory(beveragesData, 100, 500, 2000);
...
export default function Beverages({ beverages }) {
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 5;
